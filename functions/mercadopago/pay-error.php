...
<script>
    ...
    Swal.fire({
        ...
        text: "Estimado usuario, su pago no pudo ser procesado, por favor vuelva a intentarlo, o comuníquese con nosotros.",
        icon: "error",
        ...
        if (result.isConfirmed) {
            window.location.href = "https://eldiadetusuerte.com";
        }
    });
</script>
